...
Notification.create(user: users[1], action: true, notification_type: 'cant_make_shift_request',
  data: { user_shift_id: UserShift.scheduled.last.id })
...
Notification.create(user: users[1], action: true, notification_type: 'trade_shift_request',
  data: { from_user_shift_id: UserShift.scheduled.first.id, to_user_shift_id: UserShift.scheduled.last.id })
Notification.create(user: users[1], action: true, notification_type: 'update_availability',
